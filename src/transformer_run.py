...
from emoji_prediction.utils.data_util import DataSet, initialize_weights_xavier_uniform
from emoji_prediction.methods.transformer_model import Transformer, Encoder
...
from emoji_prediction.config.transformer_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
    TEST_NORMAL_DATA_PATH, VALIDATION_NORMAL_DATA_PATH, SKIPGRAM_NEWS_300D, HID_DIM, ENC_LAYERS,\
    ENC_HEADS, ENC_PF_DIM, ENC_DROPOUT, DEVICE, N_EPOCHS, MODEL_PATH, FINAL_DROPOUT,\
    LOSS_CURVE_PATH, ACC_CURVE_PATH, TEST_AUG_LOG_PATH, ADDING_NOISE, LR_DECAY,\
    TRAIN_AUGMENTATION, TEST_AUGMENTATION, EMOTION_EMBEDDING_PATH, TEXT_FIELD_PATH,\
    LABEL_FIELD_PATH, BATCH_SIZE, EMOTION_EMBEDDING_DIM, USE_EMOTION, MAX_LENGTH, MIN_FREQ
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        model = Transformer(hid_dim=HID_DIM, final_dropout=FINAL_DROPOUT, encoder=enc,
                            ...
                            src_pad_idx=data_set.pad_idx_dict["token_pad_idx"])
