...
"""
parallel_cnn_lstm_run.py is written for run parallel cnn_lstm model
"""
...
from emoji_prediction.methods.ABCDM_method import ABCDM
...
from emoji_prediction.config.ABCDM_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
    TEST_NORMAL_DATA_PATH, VALIDATION_NORMAL_DATA_PATH, SKIPGRAM_NEWS_300D, EMBEDDING_DIM,\
    DEVICE, N_EPOCHS, MODEL_PATH, N_FILTERS, FILTER_SIZE, DROPOUT, DENSE_UNITS,\
    LOSS_CURVE_PATH, ACC_CURVE_PATH, ADDING_NOISE, LR_DECAY, TRAIN_AUGMENTATION,\
    TEST_AUGMENTATION, TEST_AUG_LOG_PATH, EMOTION_EMBEDDING_PATH, EMOTION_EMBEDDING_DIM,\
    USE_EMOTION, LSTM_HIDDEN_DIM, LSTM_LAYERS, BIDIRECTIONAL, TEXT_FIELD_PATH, LABEL_FIELD_PATH,\
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        model = ABCDM(vocab_size=data_set.num_vocab_dict["num_token"],
                      ...
                      filter_sizes=FILTER_SIZE, lstm_hidden_dim=LSTM_HIDDEN_DIM,
        ...
        if USE_EMOTION:
            ...
            model.emotion_embeddings.weight.data[data_set.pad_idx_dict["token_pad_idx"]] = \
                torch.zeros(EMOTION_EMBEDDING_DIM)
