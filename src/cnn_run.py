...
from emoji_prediction.config.cnn_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
    ...
    USE_EMOTION, TEXT_FIELD_PATH, LABEL_FIELD_PATH, BATCH_SIZE, MAX_LENGTH, MIN_FREQ
...
class RunModel:
    ...
    def run(self, adding_noise=False, lr_decay=False, augmentation=True, test_augmentation=False):
        """
