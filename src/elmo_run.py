...
"""
elmo_run.py is written for run elmo model
"""
...
from emoji_prediction.methods.elmo_model import ELMo
...
from emoji_prediction.config.elmo_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        """
        # create model
        model = ELMo(vocab_size=data_set.num_vocab_dict["num_token"],
