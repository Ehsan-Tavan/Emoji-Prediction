...
from emoji_prediction.methods.RCNN_model import RCNN
...
from emoji_prediction.config.RCNN_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
    TEST_NORMAL_DATA_PATH, VALIDATION_NORMAL_DATA_PATH, SKIPGRAM_NEWS_300D,\
    EMBEDDING_DIM, DEVICE, N_EPOCHS, MODEL_PATH, DROPOUT, LSTM_HID_DIM,\
    LINEAR_UNITS, BIDIRECTIONAL, LOSS_CURVE_PATH, ACC_CURVE_PATH,\
    TEST_AUG_LOG_PATH, LR_DECAY, ADDING_NOISE, TRAIN_AUGMENTATION,\
    TEST_AUGMENTATION, EMOTION_EMBEDDING_DIM, EMOTION_EMBEDDING_PATH,\
    USE_EMOTION, LSTM_LAYERS
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        model = RCNN(vocab_size=data_set.num_vocab_dict["num_token"],
                     ...
                     lstm_hid_dim=LSTM_HID_DIM, linear_units=LINEAR_UNITS,
