...
"""
lstm_cnn_run.py is written for run LstmCnn model
"""
...
from emoji_prediction.methods.lstm_cnn_model import LstmCnn
...
from emoji_prediction.config.lstm_cnn_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
    ...
    EMOTION_EMBEDDING_DIM, EMOTION_EMBEDDING_PATH, USE_EMOTION
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        """
        # create model
        model = LstmCnn(vocab_size=data_set.num_vocab_dict["num_token"],
                        ...
                        final_dropout=FINAL_DROPOUT, middle_dropout=MIDDLE_DROPOUT,
                        lstm_hidden_dim=LSTM_HIDDEN_DIM, bidirectional=BIDIRECTIONAL,
                        filter_sizes=FILTER_SIZE, n_filters=N_FILTERS, use_emotion=USE_EMOTION,
