...
from emoji_prediction.methods.parallel_cnn_lstm_model import ParallelCnnLstm
...
from emoji_prediction.config.parallel_cnn_lstm_config import LOG_PATH, TRAIN_NORMAL_DATA_PATH,\
...
class RunModel:
    ...
    def init_model(data_set):
        ...
        """
        # create model
        model = ParallelCnnLstm(vocab_size=data_set.num_vocab_dict["num_token"],
                                ...
                                filter_sizes=FILTER_SIZE, lstm_units=LSTM_UNITS,
                                lstm_layers=LSTM_LAYERS, bidirectional=BIDIRECTIONAL,
                                start_dropout=START_DROPOUT, end_dropout=END_DROPOUT,
                                middle_dropout=MIDDLE_DROPOUT,  use_emotion=USE_EMOTION,
